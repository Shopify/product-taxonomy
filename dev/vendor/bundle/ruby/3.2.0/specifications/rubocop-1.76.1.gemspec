...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop/rubocop/issues", "changelog_uri" => "https://github.com/rubocop/rubocop/releases/tag/v1.76.1", "documentation_uri" => "https://docs.rubocop.org/rubocop/1.76/", "homepage_uri" => "https://rubocop.org/", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rubocop/rubocop/" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.45.0", "< 2.0"])
