    ...
    module ReturnReason
      module Docs
        class ReversedSerializerTest < TestCase
          ...
          test "serialize_all sorts return reasons with unknown last, other second-to-last" do
            ...
            # Should be sorted: normal reasons alphabetically (priority 0), then unknown (priority 1), then other (priority 2)
